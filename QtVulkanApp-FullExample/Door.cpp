...
Door::Door() : VisualObject() {
    // Initialize the door with default values
    ...
    // Apply scaling and position the door
    mMatrix.setToIdentity();
    mPosition = QVector3D(10.0f, 0.0f, 11.5f);  //initial position
    mMatrix.scale(1.0f);      // Scale the door normally (can change based on size)
...
void Door::createDoor() {
    ...
    // Vertices for a simple rectangular door (orange color)
